    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            switch (github.context.eventName) {
                case 'issue_comment':
                    return issue_comment_1.checkIssueComment(github.context, () => {
                        octokit.issues.updateComment(Object.assign({}, github.context.repo, { 'comment_id': github.context.payload.comment.id, 'body': 'I am so sorry! :pray:' }));
                    });
                case 'issues':
